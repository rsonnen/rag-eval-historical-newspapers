...
def build_file_urls(page: dict[str, Any]) -> dict[str, str]:
    ...
    return {
        ...
        "txt": (
            f"{TEXT_SERVICES_URL}?segment=/service/{batch_path}.xml&format=alto_xml&full_text=1"
        ),
    }
    ...
    *,
    ...
    if metadata_path.exists():
        with metadata_path.open(encoding="utf-8") as f:
            ...
            existing_metadata = {item["page_id"]: item for item in existing_data.get("pages", [])}
...
Examples:
    ...
    parser.add_argument("--corpus", type=str, required=True, help="Corpus directory name")
    parser.add_argument("--max-pages", type=int, default=150, help="Max pages (default: 150)")
